...
namespace OnePiece.Framework.Core
{
    public static class Int32Extensions
    {
        ...
        public static UInt32 ToUInt32(this int? value)
        {
            return checked((uint)value.GetValueOrDefault());
        }
        ...
        public static Int32 ToInt32(this uint value)
        {
            return checked((int)value);
        }

        public static int Opposite(this int value)
        {
            return -1 * value;
        }
        ...
        public static int Positive(this int value, bool takeAbs = true)
        {
            if (value < 0)
            {
                if (takeAbs) return -1 * value;
                return 0;
            }
