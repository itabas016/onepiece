...
namespace OnePiece.Framework.Tests.Core.RedisMapper
{
    public class MasterOnlyRedisServiceTest
    {
        ...
        {
            SingletonBase<ConfigurableSet>.Instance[RedisConfigKeys.REDIS_READ_WRITE_SERVERS] = "127.0.0.1:6379";
            SingletonBase<ConfigurableSet>.Instance[RedisConfigKeys.REDIS_READONLY_SERVERS] = "127.0.0.1:6379;127.0.0.1:6377";
